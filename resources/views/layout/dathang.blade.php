								...
								<!--  one item	 -->
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="color-gray your-order-info">Đơn giá: {{number_format($cart['promotion_price'])}} đồng</span>
							...
							<ul class="payment_methods methods">
								...
								<li class="payment_method_cheque">
									...
									<div class="payment_box payment_method_cheque" style="display: none;">
										...
										<br>- Chủ TK: Nguyễn Mạnh Cường
										<br>- Ngân hàng VietTinBank, Chi nhánh Lào Cai
									</div>						
								</li>
